...
public class EntityActivity extends AppCompatActivity {
    ...
    public void bindViews(){
        ...
        mEntity.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_CAP_SENTENCES);
    ...
    public void attempAddEntity(){
        ...
        nameEntity = nameEntity.substring(0,1).toUpperCase()+nameEntity.substring(1);
        Log.d(TAG, "Nombre de entidad "+nameEntity);
        float rating = mRatingBar.getRating();
        Log.d(TAG, "Rating  "+rating);
        cancel = false;
        focusView = null;
        Entity e = new Entity(timestamp,nameEntity,rating);
